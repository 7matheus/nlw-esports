              ...
              <form onSubmit={handleCreatedAt} className="mt-8 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Input name="discord" id="discord" type="text" placeholder="User#0001" />
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col gap-2 flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Input name="hourStart" id="hourStart" type="time" placeholder='Até' />
                ...
                <footer className="mt-4 flex justify-end gap-4">
                  ...
                  <button 
                    type="submit"
                    className="bg-violet-500 hover:bg-violet-600 flex items-center px-5 h-12 rounded-md font-semibold gap-3 "
                  >
